...
if (use_grafted.eq.1) then
    ...
    write(iow,'(3X,A40,E16.9,A11)')adjl("Squared gyration radius of grafted ch:",40)&
                                                  &,Rg2_per_mon_gr*chainlen_gr," [Angstrom]"
    write(6  ,'(3X,A40,E16.9,A11)')adjl("Squared gyration radius of grafted ch:",40)&
                                                  &,Rg2_per_mon_gr*chainlen_gr," [Angstrom]"
...
write(iow,'(3X,A40,E16.9,A11)')adjl("Squared gyration radius of matrix ch:",40)&
                                   &,Rg2_per_mon_matrix * chainlen_matrix," [Angstrom]"
write(6  ,'(3X,A40,E16.9,A11)')adjl("Squared gyration radius of matrix ch:",40)&
                                   &,Rg2_per_mon_matrix * chainlen_matrix," [Angstrom]"

!calculate segment density in the bulk, rho_0, in mol_segments/m3
rho_0 = massden/mon_mass*1.d06
write(iow,'(3X,A40,E16.9,A10)')adjl("Segment density in bulk (rho):",40),rho_0," [mol/m^3]"
write(6  ,'(3X,A40,E16.9,A10)')adjl("Segment density in bulk (rho):",40),rho_0," [mol/m^3]"
