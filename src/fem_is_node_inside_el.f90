...
subroutine fem_is_node_inside_el(xl, x_test, y_test, z_test, lint, sv, volel, inside, shp, numDimensions, nel)
!--------------------------------------------------------------------------------------------------------------------------------------------!
implicit none
!--------------------------------------------------------------------------------------------------------------------------------------------!
...
do pp = 1, 4
  ...
  do ll = 1, lint
    call fem_tetshpfun(sv(1,ll), xl, numDimensions, nel, xsj, shp)
