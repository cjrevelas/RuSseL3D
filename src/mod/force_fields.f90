...
subroutine hamaker_sphere_plate(h12, r_pol, sigma1, sigma2, A1, A2, Urep, Uatt)
!------------------------------------------------------------------------------------------------------!
implicit none
!------------------------------------------------------------------------------------------------------!
real(8), intent(in)  :: h12, r_pol, sigma1, sigma2, A1, A2
real(8), intent(out) :: Urep, Uatt
real(8)              :: sigma = 0.d0, hamaker_constant = 0.d0, h_12 = 0.d0
!------------------------------------------------------------------------------------------------------!
...
subroutine hamaker_sphere_sphere(h12, r1, r2, sigma1, sigma2, A1, A2, Urep, Uatt)
!------------------------------------------------------------------------------------------------------!
implicit none
!------------------------------------------------------------------------------------------------------!
real(8), intent(in)  :: h12, r1, r2, sigma1, sigma2, A1, A2
real(8), intent(out) :: Urep, Uatt
real(8)              :: r12 = 0.d0, sigma = 0.d0, hamaker_constant = 0.d0, h_12 = 0.d0
!------------------------------------------------------------------------------------------------------!
!***SI units are used everywhere***
Urep = 0.d0
Uatt = 0.d0
