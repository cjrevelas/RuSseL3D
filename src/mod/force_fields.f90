...
subroutine hamaker_sphere_plate(Temp, h12, rho_0, sigma1, sigma2, Aps, Asio2, r12, Urep, Uatt, Utot)
!------------------------------------------------------------------------------------------------------!
use error_handing
use constants
!------------------------------------------------------------------------------------------------------!
...
subroutine hamaker_sphere_sphere(Temp, h12, sphere_radius, rho_0, sigma1, sigma2, Aps, Asio2, r12, Urep, Uatt, Utot)
!------------------------------------------------------------------------------------------------------!
use error_handing
use constants
!------------------------------------------------------------------------------------------------------!
