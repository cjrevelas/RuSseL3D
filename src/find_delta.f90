...
real(8), dimension(numnp,ns_gr_conv+1), intent(in) :: qm_interp_mg
...
real(8), dimension(numnp,2)                        :: qgr
real(8), dimension(numnp,ns_gr_ed+1)               :: qgr_final
real(8), dimension(numnp,ns_gr_conv+1)             :: qgr_interp
...
do i1 = 1, num_gpoints
    write(5,'(I5,3(1X,E18.9))') gpid(i1), qm_interp_mg(gpid(i1),ns_gr_conv+1), delta_numer(i1), delta_anal(i1)
enddo
close(5)
