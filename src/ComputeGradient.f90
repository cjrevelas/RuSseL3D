...
real(8) function ComputeGradient(node_id, phi)
!----------------------------------------------------------------------------------------------------------!
use geometry_mod
...
phi_plus_dx  = FemInterpolation(node_id, x_node_id+dx, y_node_id, z_node_id, phi)
phi_minus_dx = FemInterpolation(node_id, x_node_id-dx, y_node_id, z_node_id, phi)

phi_plus_dy  = FemInterpolation(node_id, x_node_id, y_node_id+dy, z_node_id, phi)
phi_minus_dy = FemInterpolation(node_id, x_node_id, y_node_id-dy, z_node_id, phi)

phi_plus_dz  = FemInterpolation(node_id, x_node_id, y_node_id, z_node_id+dz, phi)
phi_minus_dz = FemInterpolation(node_id, x_node_id, y_node_id, z_node_id-dz, phi)
