...
if (graftedExist.eq.1) then
  ...
  if (log_contourGrafted) then
    ...
    elseif (contourGrafted.eq.contour_hybrid) then
      ...
      call compute_contour_step(stepEdwAveGrafted, critContourGrafted, lengthGrafted, numEdwPointsGrafted)
...
if (matrixExist.eq.1) then
  ...
  if (log_contourMatrix) then
    ...
    elseif (contourMatrix.eq.contour_hybrid) then
      ...
      call compute_contour_step(stepEdwAveMatrix, critContourMatrix, lengthMatrixMax, numEdwPointsMatrix)
