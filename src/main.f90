...
call periodic_dumper(qm_final, qgr_final, qm_interp_mm, qm_interp_mg, qgr_interp, phia_mx, phia_gr, wa, wa_new, wa_mix)
call export_field(wa_mix, numnp, iter)
if (matrix_exist.eq.1) call compute_phi_end_middle(ns_matrix_ed, qm_final, qm_final, "matrix")
if (grafted_exist.eq.1) call compute_phi_end_middle(ns_gr_conv, qgr_interp, qm_interp_mg, "graftd")
