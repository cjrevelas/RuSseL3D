subroutine export_phi_nodal(phia_mx, phia_gr, numnp, xc)
!-----------------------------------------------------------------------------------------------------------!
...
write(120,'(6(A19))') "np", "x", "y", "z", "phi_m", "phi_g"
do kk = 1, numnp
   write(120,'(I19,5(E19.9E3))') kk, xc(1,kk), xc(2,kk), xc(3,kk), phia_mx(kk), phia_gr(kk)
enddo
close(120)
!-----------------------------------------------------------------------------------------------------------!
