...
implicit none
!--------------------------------------------------------------------!
real(8) :: dterm1(numnp), dterm2(numnp), Q
!--------------------------------------------------------------------!
term1 = 0.d00
term2 = 0.d00
term3 = 0.d00
...
! x1.0D+03 ----> N/m --> mN/m
part_sum1 = term1 * rho_0 * k_B * Temp / dfloat(chainlen) * 1.0D+03
part_sum2 = term2 * rho_0 * k_B * Temp / dfloat(chainlen) * 1.0D+03
part_sum3 = term3 * rho_0 * k_B * Temp / dfloat(chainlen) * 1.0D+03
part_sum4 = term4 * rho_0 * k_B * Temp / dfloat(chainlen) * 1.0D+03
...
return
!--------------------------------------------------------------------!  
end subroutine adhesion_tension_alternative
