...
def edit_model_size_parameters(boxLx, boxLy, boxLz, Rnp_eff, centers):
    ...
    print("radius: ", Rnp_eff)
    set_variable_value("RNP_EFF", Rnp_eff, "rsl3d_mesh_gen.m")
...
Lx = 264.0 #gp_dist_benchmark 380.0
Ly = 220.0 #gp_dist_benchmark 380.0
Lz = 220.0 #gp_dist_benchmark 380.0

num_part = 2  #gp_dist_benchmark: 1
radius   = 24.0 #gp_dist_benchmark: 14
h_ss     = 14.0
...
use_gr  = True
importt = False #gp_dist_benchmark: True
numgp   = 40    #gp_dist_benchmark: 2
...
mesh = Mesh(planar, use_gr, numgp, radius + 0.4, move, move_by_xx, reflect, importt)

mesh.matlab("tmp_graftpoints")

mesh.graftpoints.insert_to_model_file()

edit_model_size_parameters(Lx, Ly, Lz, radius, centers)
